...
#define TACHYON_WFP_CAP_INJECT_RECEIVE (UINT64_C(1) << 8)
#define TACHYON_WFP_CAP_INJECTION_STATE (UINT64_C(1) << 9)
#define TACHYON_WFP_CAP_BOUNDED_QUEUE (UINT64_C(1) << 10)
#define TACHYON_WFP_CAP_FAIL_OPEN_TIMEOUT (UINT64_C(1) << 11)
#define TACHYON_WFP_CAP_POLICY_GENERATION (UINT64_C(1) << 12)
...
enum TACHYON_WFP_VERDICT_ACTION {
    ...
    TachyonWfpVerdictInjectToApplication = 4
};
